...
<body id="home">
  <nav class="navbar">
    <div class="container">
      <div class="logo"><img src="assets/img/logo.png" alt="COMME des GARÇONS parfums">
      </div>
      <ul class="nav">
        <li><a href="#">Home</a></li>
...
<!-- Section A -->
    ...
    <section class="section-a">
      <div class="container">
        <div class="left">
          <img src="assets/img/rouge_bottle.png" alt="Rouge bottle">
        </div>
        <div class="right">
...
<!-- Section B -->
    ...
    <section class="section-b" id="about">
      ...
      <div class="container">
        ...
        <div class="right">
          <img src="assets/img/bottle_box.png" alt="Rouge bottle">
        </div>
      </div>
    </section>
...
<!-- Section C -->
    ...
    <section class="section-c" id="gallery">
      <!-- <div class="container"> -->
      <div class="gallery">
        <a href="assets/img/by_hemingway.jpg" class="big">
          <img src="assets/img/by_hemingway.jpg" alt="Rouge by Jordan Hemingway">
        </a>

        <a href="assets/img/with_bg.jpg" class="big">
          <img src="assets/img/with_bg.jpg" alt="Rouge bottle photo with woman face">
        </a>

        <a href="assets/img/woman_face.jpg" class="big">
          <img src="assets/img/woman_face.jpg" alt="Rouge bottle photo with woman face">
        </a>

        <a href="assets/img/Rouge_box.jpg" class="big">
          <img src="assets/img/Rouge_box.jpg" alt="Rouge box">
        </a>

        <a href="assets/img/in_red1.jpg" class="big">
          <img src="assets/img/in_red1.jpg" alt="Rouge bottle in red 1">
        </a>

        <a href="assets/img/in_red2.jpg" class="big">
          <img src="assets/img/in_red2.jpg" alt="Rouge bottle in red2">
        </a>

        <a href="assets/img/in_red3.jpg" class="big">
          <img src="assets/img/in_red3.jpg" alt="Rouge bottle in red 3">
        </a>
      </div>
    <!-- </div> -->
    </section>
    ...
    <footer class="section-footer">
      <div class="container">
        <div>
          ...
          <a href="https://www.comme-des-garcons-parfum.com/"><img src="assets/img/CDG_icon.png" alt="COMME des GARÇONS"></a>
          <a href="https://www.instagram.com/commedesgarconsparfums/"><img src="assets/img/instagram_icon.png" alt="Instagram icon"></a>
        </div>
        <div>
        ...
        <div>
          ...
          <h3>Subscribe</h3>
          <p>You'll get an additional info about COMME des GARÇONS (and with my CV too)</p>
